...
const DetalhesEletronico: React.FC = () => {
    ...
    const fetchItem = async () => {
      ...
      if (id) {
        try {
          ...
          setError("Não foi possível carregar os detalhes do eletrônico. Tente novamente mais tarde.");
          setItem(null);
        } finally {
          setLoading(false);
        }
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="text-2xl font-bold text-primary mb-0">Detalhes do Eletrônico</h1>
        <button
